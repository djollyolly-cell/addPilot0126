...
export const TIERS = {
  ...
  agency_s: {
    ...
    maxManagers: 3,
    maxNiches: 3,
    features: ["6–30 кабинетов", "Конструктор правил (L2)", "До 3 менеджеров", "До 3 ниш", "Приоритетная поддержка", "Мониторинг здоровья аккаунтов", "Месячный отчёт по нагрузке"],
  },
  agency_m: {
    name: "Agency M",
    price: 24900,
    ...
    maxManagers: 10,
    maxNiches: 6,
    features: ["12–60 кабинетов", "Конструктор правил (L2)", "До 10 менеджеров", "До 6 ниш", "Приоритетная поддержка", "Мониторинг здоровья аккаунтов", "Месячный отчёт по нагрузке"],
  },
  agency_l: {
    name: "Agency L",
    price: 39900,
    ...
    maxManagers: 30,
    maxNiches: -1,
    features: ["24–120 кабинетов", "Конструктор правил (L2)", "До 30 менеджеров", "Все ниши", "Приоритетная поддержка", "Мониторинг здоровья аккаунтов", "Месячный отчёт по нагрузке", "Выделенный IP", "Кастомные типы правил (L3)", "SLA на синхронизацию"],
  },
  ...
  agency_xl: {
    ...
    maxManagers: -1,
    maxNiches: -1,
    features: ["40+ кабинетов", "Всё из Agency L", "Персональный менеджер", "Индивидуальная цена"],
  },
} as const;
