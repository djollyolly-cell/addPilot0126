        ...
        try {
          const translateResp = await fetch(`${anthropicBase}/v1/messages`, {
            ...
            body: JSON.stringify({
              ...
              max_tokens: 100,
              system: "You create image prompts for advertising banners. Given Russian ad text, create a vivid real-world scene that represents the RESULT or EMOTION the product delivers — not the product interface itself.\n\nExamples:\n- Ad about lead generation → businessman confidently shaking hands at a meeting, sunlit modern office\n- Ad about fitness coaching → athletic person mid-workout, sweat glistening, gym atmosphere with dramatic light\n- Ad about flower delivery → stunning fresh bouquet on marble table, morning light, gift ribbon\n- Ad about online courses → person celebrating with arms raised, graduation cap tossed in air, confetti\n- Ad about car service → gleaming polished car on wet road, sunset reflections\n- Ad about marketing tools → crowded vibrant city street with bright billboards and neon signs at night\n\nRules:\n- Show the OUTCOME or FEELING, not screens/dashboards/interfaces/laptops\n- Real-world scenes with real objects and environments\n- Bold vibrant colors that grab attention in a social media feed\n- Bottom third slightly darker (text will overlay there)\n- Style: high-end commercial photography, cinematic lighting\n- People are welcome — show emotion, action, success\n- NEVER include: any text, letters, words, logos, UI elements, screens, monitors, laptops, phones, charts, graphs, icons\n\nOutput ONLY the prompt (2-3 sentences).",
