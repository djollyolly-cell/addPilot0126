        ...
        <div className="prose prose-slate max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
              ...
              <li>После оформления Подписки и списания регулярного платежа, Пользователь получит от платежной системы письмо с электронным чеком. В этом письме также будет ссылка на отмену Подписки. Для получения этого письма важно указать e-mail при создании Подписки.</li>
            </ul>
          </section>
