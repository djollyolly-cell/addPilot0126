...
Вердикт: "ok: N/N синхронизируются" / "warning: N отстают" / "error: N в ошибке"
...
Скорость: 30-120 секунд. Включает VK API запросы, per-user с пагинацией. 9 блоков проверок.
